...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View view = LayoutInflater.from(mContext).inflate(R.layout.todo_item,
				parent, false);
		...
		final CheckBox statusView = (CheckBox) view
				.findViewById(R.id.statusCheckBox); // null;
		...
		final TextView priorityView = (TextView) view
